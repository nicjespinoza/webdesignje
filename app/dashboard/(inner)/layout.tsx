            ...
            <header className="w-full bg-[#020202]/80 backdrop-blur-xl border-b border-white/5 z-50">
                <div className="px-8 md:px-16 h-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-6">
                        <button
                            onClick={toggleTheme}
                            className="text-white/20 hover:text-primary transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary rounded-md p-1"
