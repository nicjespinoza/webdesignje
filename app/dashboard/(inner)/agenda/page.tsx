                        ...
                        <div className="p-10 flex justify-between items-center bg-muted/30 border-b border-border/40">
                            ...
                            <div className="flex items-center gap-4">
                                <div className="flex items-center gap-2 p-2 bg-background/50 rounded-2xl border border-border/40 shadow-inner">
                                    <button aria-label={t('dashboard.agendaActions.previousMonth')} title={t('dashboard.agendaActions.previousMonth')} onClick={() => changeMonth(-1)} className="p-3 hover:bg-card rounded-xl transition-all text-muted-foreground hover:text-primary focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary"><ChevronLeft size={20} /></button>
                                    ...
                                    <button aria-label={t('dashboard.agendaActions.nextMonth')} title={t('dashboard.agendaActions.nextMonth')} onClick={() => changeMonth(1)} className="p-3 hover:bg-card rounded-xl transition-all text-muted-foreground hover:text-primary focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary"><ChevronRight size={20} /></button>
                                </div>
                            </div>
                        </div>
                                        ...
                                        >
                                            ...
                                            <div className="p-6 rounded-[2rem] bg-background/50 border border-border/40 hover:border-primary/20 transition-all shadow-sm hover:shadow-md">
                                                <div className="flex justify-between items-start mb-4">
                                                    ...
                                                    <button
                                                        aria-label={t('dashboard.agendaActions.deleteAppointment')}
                                                        title={t('dashboard.agendaActions.deleteAppointment')}
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-xl p-6">
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center mb-10">
                                ...
                                <button aria-label={t('dashboard.agendaActions.closeModal')} title={t('dashboard.agendaActions.closeModal')} onClick={() => setShowNewAppointmentModal(false)} className="p-4 bg-muted hover:bg-destructive hover:text-white rounded-[1.5rem] transition-all border border-border/40 shadow-soft focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary">
                                    <X size={20} />
                                </button>
                            </div>
