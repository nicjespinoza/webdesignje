  ...
  en: {
    translation: {
      nav: {
        ...
        select_lang: 'Select {{lang}} language',
      },
      hero: {
  ...
  es: {
    translation: {
      nav: {
        ...
        about: 'Sobre Mí',
        contact: 'Contacto',
        toggle_menu: 'Alternar menú móvil',
        select_lang: 'Seleccionar idioma {{lang}}',
      },
      hero: {
  ...
  fr: {
    translation: {
      nav: {
        ...
        select_lang: 'Sélectionner la langue {{lang}}',
      },
      hero: {
