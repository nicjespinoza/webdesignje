  ...
  en: {
    translation: {
      nav: {
        ...
        about: 'About Me',
        contact: 'Contact Me',
        languageToggle: 'Change Language: {{lang}}',
  ...
  es: {
    translation: {
      nav: {
        ...
        about: 'Sobre Mí',
        contact: 'Contacto',
        languageToggle: 'Cambiar idioma: {{lang}}',
  ...
  fr: {
    translation: {
      nav: {
        ...
        languageToggle: 'Changer de langue : {{lang}}',
  ...
  zh: {
    translation: {
      nav: {
        ...
        about: '關於我',
        contact: '聯繫我',
        languageToggle: '更改語言：{{lang}}',
        mobileMenuToggle: '切換移動選單',
      },
      hero: {
        badge: '可承接新專案',
        title: '簡化您日常生活的智能自動化',
