    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'glass-panel py-3 shadow-lg backdrop-blur-md' : 'py-6 bg-transparent'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button onClick={toggleTheme} aria-label="Toggle theme" className="p-2 rounded-full hover:bg-white/5 focus-visible:ring-2 focus-visible:outline-none transition-colors">
          ...
          >
            <div className="flex flex-col p-6 gap-4">
              ...
              <div className="flex gap-4 mt-4">
                ...
                <button onClick={toggleTheme} aria-label="Toggle mobile theme" className="flex items-center gap-2 text-sm px-3 py-1 border border-white/20 rounded focus-visible:ring-2 focus-visible:outline-none">
      ...
      >
        {isLoading ? (
            ...
            >
                ...
                <button aria-label="Read more" className="text-brand-indigo hover:text-white focus-visible:ring-2 focus-visible:outline-none transition-colors">
                    <ArrowRight size={20} />
                </button>
                </div>
            </motion.article>
      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        >
             ...
             <div className="mt-12 flex justify-center gap-8 border-t border-white/10 pt-8">
                 <a href="#" aria-label="GitHub profile" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:outline-none transition-colors"><Github size={24} /></a>
                 <a href="#" aria-label="LinkedIn profile" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:outline-none transition-colors"><Linkedin size={24} /></a>
                 <a href="#" aria-label="Twitter profile" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:outline-none transition-colors"><Twitter size={24} /></a>
             </div>
        </motion.div>
      </div>
    </section>
  ...
  return (
    <footer className="py-12 relative z-10 border-t border-white/5 bg-slate-950 overflow-hidden">
      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
        ...
        <div className="flex gap-4">
             <a href="#" aria-label="GitHub profile" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:outline-none transition-colors"><Github size={20} /></a>
             <a href="#" aria-label="LinkedIn profile" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:outline-none transition-colors"><Linkedin size={20} /></a>
             <a href="#" aria-label="Twitter profile" className="text-slate-400 hover:text-white focus-visible:ring-2 focus-visible:outline-none transition-colors"><Twitter size={20} /></a>
        </div>
      </div>
    </footer>
  );
