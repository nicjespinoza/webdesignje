    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'glass-panel py-3 shadow-lg backdrop-blur-md' : 'py-6 bg-transparent'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button aria-label="Toggle theme" onClick={toggleTheme} className="p-2 rounded-full hover:bg-white/5 transition-colors focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-brand-indigo">
        ...
        {/* Mobile Toggle */}
        <button aria-label="Toggle menu" className="md:hidden focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-brand-indigo rounded p-1" onClick={() => setIsOpen(!isOpen)}>
          {isOpen ? <X /> : <Menu />}
        </button>
      </div>
