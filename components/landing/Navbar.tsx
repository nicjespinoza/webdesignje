      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        <a href="#" className="flex items-center gap-3 group">
          ...
          <div className="leading-none flex flex-col">
            ...
            <span className="text-xs font-medium tracking-[0.2em] text-slate-300 font-sans opacity-80">
              Web Design
            </span>
          </div>
        </a>
          ...
          <div className="flex items-center gap-1.5 p-1 glass-panel rounded-full border border-white/5 bg-white/5 shadow-inner">
            {languages.map(l => (
              <button
                ...
                aria-pressed={lang === l}
                aria-label={languageConfig[l].name}
        ...
        <button
          ...
          aria-label={
            isOpen
              ...
              : t('nav.stack', { lng: lang }) /* fallback simple text */
          }
        >
