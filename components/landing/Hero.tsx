...
const Hero = ({ lang = 'es' }: HeroProps) => {
  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col justify-center items-center pt-20 md:pt-24 overflow-hidden bg-transparent pointer-events-none">


      <div className="container mx-auto px-6 md:px-8 relative z-10 flex flex-col items-center justify-center text-center mt-4 md:mt-8 pointer-events-auto">
        ...
        <motion.div
          ...
          className="flex flex-wrap justify-center gap-4 md:gap-6 mb-20 md:mb-24"
        >
          <motion.a
