...
const NeuralNetwork = ({ count = 120, radius = 4.5 }) => {
  ...
  const connections = useMemo(() => {
    ...
    // Optimization: avoid Math.sqrt in high-frequency loop
    // (cannot easily halve iterations here because threshold/strength depends on the specific source node's layer)
