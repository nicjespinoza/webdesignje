                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    {!isAssistant && (
                        <div className="flex items-center gap-2">
                            ...
                            <button onClick={onViewNotes} aria-label={t('common.viewNotes')} title={t('common.viewNotes')} className="p-2.5 border border-white/5 hover:border-white/20 text-white/20 hover:text-white rounded-r-full transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={onViewEndoscopic} aria-label={t('common.viewEndoscopic')} title={t('common.viewEndoscopic')} className="p-2.5 border border-white/5 hover:border-white/20 text-white/20 hover:text-white rounded-r-full transition-all focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary">
                            <Eye size={12} strokeWidth={1} />
                        </button>
                    </div>
