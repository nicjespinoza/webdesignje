                    ...
                    >
                        ...
                        <div className="flex items-center gap-6 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-all duration-700">
                            <button
                                ...
                                aria-label={t("patientProfile.deleteHistory")}
                                title={t("patientProfile.deleteHistory")}
                            ...
                            <div className="p-2.5 rounded-full border border-primary/10 text-primary group-hover:scale-110 transition-transform" aria-label={t("patientProfile.viewHistory")} title={t("patientProfile.viewHistory")}>
