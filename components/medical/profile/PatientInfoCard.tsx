            ...
            <div className="flex flex-col items-center mb-14 relative group/avatar">
                <div className="relative">
                    <div className="w-36 h-36 rounded-2xl overflow-hidden bg-white/5 border border-white/5 mb-6 group-hover/avatar:border-primary/40 transition-all duration-1000 relative">
                        ...
                        <button type="button" aria-label={t('common.updateProfileImage')} title={t('common.updateProfileImage')} className="absolute inset-0 bg-black/60 opacity-0 group-hover/avatar:opacity-100 transition-opacity flex items-center justify-center cursor-pointer focus-visible:opacity-100 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-primary rounded-2xl" onClick={() => fileInputRef.current?.click()}>
