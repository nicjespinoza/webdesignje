...
const ParticleBackground: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const updateParticle = (p: CanvasParticle, others: CanvasParticle[]) => {
            ...
            // Optimization: avoid Math.sqrt calculation by using squared distances for thresholds
        ...
        const drawLines = () => {
            for (let i = 0; i < particles.length; i++) {
                for (let j = i + 1; j < particles.length; j++) {
                    ...
                    // Optimization: avoid Math.sqrt calculation for lines outside threshold
                    if (distSq < maxDistSq) {
