...
const NeuralNetwork = ({ count = 60, radius = 4 }) => {
  ...
  const connections = useMemo(() => {
    ...
    // ⚡ Bolt Optimization: Replace distanceTo with distanceToSquared to avoid O(N^2) Math.sqrt calls
...
const DataPulses = ({ radius }: { radius: number }) => {
    ...
    useFrame(() => {
        ...
        agents.forEach((agent, i) => {
            ...
            // ⚡ Bolt Optimization: Replace distanceTo with distanceToSquared to avoid Math.sqrt in high-frequency useFrame
