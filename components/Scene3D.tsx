...
const NeuralNetwork = ({ count = 60, radius = 4 }) => {
  ...
  const connections = useMemo(() => {
    ...
    const threshold = 2.5;
    const thresholdSq = threshold * threshold; // ⚡ Optimize: Precalculate squared threshold

    // ⚡ Optimize: Use standard for loop starting j at i + 1 to avoid duplicate connections and halve iterations
