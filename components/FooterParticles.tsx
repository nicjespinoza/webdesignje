  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        // Optimization: iterate from i+1 to halve iterations, skip self-comparison, and use distanceToSquared
        ...
        // Optimization: use distanceToSquared to avoid expensive Math.sqrt check
        const distSq = dx * dx + dy * dy;
