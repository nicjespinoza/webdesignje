  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        ...
        // ⚡ Bolt Optimization: Using squared distance for O(N^2) loops to avoid expensive Math.sqrt calls
        ...
        // ⚡ Bolt Optimization: Using squared distance to avoid expensive Math.sqrt calls
